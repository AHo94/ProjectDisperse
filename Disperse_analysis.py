...
def Save_NumPartPerFil(name, FilPos, FilID, npart, nsig):
	...
	def ZMQ_call():
		...
		stop_messager.bind("tcp://127.0.0.1:5005")
		...
		pickle.dump(Distances, open(cachefile_distances, 'wb'))
		pickle.dump(FilamentAxis, open(cachefile_segIDs, 'wb'))
